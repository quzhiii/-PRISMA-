...
### 🎉 v4.0 新功能（面向科研小白优化）
- 📦 **一键加载示例数据**：新手可立即体验完整流程
- 📚 **数据库导出教程**：详细的PubMed、知网、WoS、Cochrane导出步骤
- 🎬 **视频教程入口**：图文并茂的使用指导
- 🔍 **智能错误提示**：详细的错误原因分析和解决建议
- 💡 **新手引导面板**：醒目的入门帮助，降低使用门槛
...
**GitHub Pages:** https://[quzhiii].github.io/literature-screening-v30/

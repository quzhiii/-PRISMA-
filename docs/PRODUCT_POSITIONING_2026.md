...
| V2.5.1 project history rollback | 已完成 patch line：本地历史快照、版本恢复、来源文件增减后的可恢复状态已合并到 `main` |
...
2. 当前公开基准以 `README.md` / `README_EN.md` 和 V2.5 工作台为准；V2.4 质量评价、V2.5 双人复核和 V2.5.1 历史回溯均已完成。
...
4. V2.7 Chinese-source reliability 是 V2.6 之后的下一阶段：中文源可靠性是数据质量可见性层，不是自动筛选决策层。

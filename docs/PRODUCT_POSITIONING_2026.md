...
| V2.7 Chinese-source reliability | 已完成 reliability slice：fixture-backed CNKI / Wanfang / VIP / SinoMed 字段映射、摘要截断 / 噪音 / 映射不完整提示；defense pack 按来源数据库和警告类型双层汇总；中文源可靠性是数据质量可见性层，不是自动筛选决策层 |
...
2. 当前公开基准以 `README.md` / `README_EN.md` 和 V2.5 工作台为准；V2.5.1 是当前 patch-line 能力，Reviewer Bundle protocol、V2.7 Chinese-source reliability 与 V2.6 Conservative AI foundation 属于已完成能力切片。
...
4. V2.7 Chinese-source reliability 已完成：fixture-backed CNKI / Wanfang / VIP / SinoMed hardening、摘要截断 / 噪音 / 映射不完整提示和 defense pack 双层汇总已落地；中文源可靠性是数据质量可见性层，不是自动筛选决策层。
